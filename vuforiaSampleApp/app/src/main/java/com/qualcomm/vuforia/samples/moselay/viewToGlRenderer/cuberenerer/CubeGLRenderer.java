package com.qualcomm.vuforia.samples.moselay.viewToGlRenderer.cuberenerer;
...
//    private int mTextureDataHandle;
    ...
    public CubeGLRenderer(Context context,SampleApplicationSession vuforiaAppSession) {
        this(context);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        ((ObjectTargets)mContext).loadingDialogHandler
